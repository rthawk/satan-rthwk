...
[_BL] = KEYMAP_ANSI(
  F(0),      KC_1,   KC_2,   CTL_T(KC_3), KC_4,   KC_5,   KC_6,   KC_7,   CTL_T(KC_8),  KC_9,    KC_0,    KC_MINS,  KC_EQL,   KC_BSPC, \
...
[_FL] = KEYMAP_ANSI(
  ...
  KC_TRNS,  KC_BTN1,  KC_BTN2,  KC_PGDN,   KC_TRNS,  KC_TRNS,  KC_LEFT,  KC_DOWN,        KC_UP,        KC_RIGHT,       KC_TRNS,  KC_TRNS,          KC_TRNS, \
